...
void write_test_system(const char *outputdir)
{
    ...
    cb.setNumberDefaultValue("a0Node->coefficient", APUNUM_FLOAT(coeffs.a0), APUNUM_FLOAT);
    cb.setNumberDefaultValue("a1Node->coefficient", APUNUM_FLOAT(coeffs.a1), APUNUM_FLOAT);
    cb.setNumberDefaultValue("a2Node->coefficient", APUNUM_FLOAT(coeffs.a2), APUNUM_FLOAT);
    cb.setNumberDefaultValue("b1Node->coefficient", APUNUM_FLOAT(coeffs.b1), APUNUM_FLOAT);
    cb.setNumberDefaultValue("b2Node->coefficient", APUNUM_FLOAT(coeffs.b2), APUNUM_FLOAT);
